...
How can do I know THIS `xpath = '//p[(((count(preceding-sibling::*) + 1) = 170) and parent::*)]'` ?
...
6. Parse the result with the `content` function
7. Either use `jsonlite` or `xml2` to parse the json or xml files
